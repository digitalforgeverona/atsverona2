...
//$pdf->Image('sponsor.gif',5,150,200);
...
$pdf->Image('tabellina.gif',$MyX,$MyYFinal+10*$i,200,80);

$pdf->SetXY($MyX, $MyYFinal+10*$i);
...
$pdf->SetXY(5, $MyYFinal+$MyH+10*$i);

$pdf->Write(0, "SAFETY OFFICER");

$pdf->Line(45, $MyYFinal+$MyH+10*$i, 100, $MyYFinal+$MyH+10*$i);

$pdf->SetXY(105, $MyYFinal+$MyH+10*$i);

$pdf->Write(0, "IL TIRATORE");

$pdf->Line(135, $MyYFinal+$MyH+10*$i, 200, $MyYFinal+$MyH+10*$i);
