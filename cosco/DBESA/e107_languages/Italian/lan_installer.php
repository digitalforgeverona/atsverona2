...
define('LANINS_000',	'Invalid stage information detected! Installation halted.');  // v. 1.0.0
...
define("LANINS_012", "Le Funzioni MySQL sembrano non esistere. Questo probabilmente significa che o l'estensione MySQL PHP non è installata oppure che la tua installazione PHP non supporta MySQL.");
...
define("LANINS_053", "e107 0.7.x richiede che sia installata l'Estensione PHP XML. Prego contatta il tuo host oppure leggi le informazioni qui: <a href='http://php.net/manual/en/ref.xml.php' target='_blank'>php.net</a> prima di continuare");
define('LANINS_054',	'The chosen database successfully checked for existence.'); // DA TRADURRE
...
define("LANINS_058", "7");
define("LANINS_060", "Impossibile leggere il datafile sqlPrego assicurati che il file <b>core_sql.php</b> esista nella directory <b>/e107_admin/sql</b>.");
...
define("LANINS_069", "e107 e' stato installato con successo!Per motivi di sicurezza dovresti impostare i permessi sul file <b>e107_config.php</b> a 644.Prego cancella anche il file <b>install.php</b> dal tuo server dopo aver cliccato il pulsante sottostante");
...
define('LANINS_071a',	'Fatto'); // v. 1.0.0
define('LANINS_071b',	'Errore nal Completamento Installazione'); // v. 1.0.0
define('LANINS_071c',	'Fatto con errori'); // v. 1.0.0
...
define("LANINS_DB_UTF8_TOOLTIP", "Se impostato, lo script di installazione cercherà di rendere il database UTF-8 compatibile se possibile. Il database UTF-8 sarà necessario per la nuova versione di e107.");
...
define("LANINS_122",	"E' possibile che tu abbia una installazione già attiva");
...
Grazie per aver scelto e107, ci auguriamo soddisfi le tue esigenze di un sito web.(Puoi cancellare questo messaggio dall'Area Amministrazione.)");

define("LANINS_NEWS", "[b]Benvenuto![/b]
e107 è un content management system scritto in PHP che usa il popolare database open source MySQL. E' completamente gratuito, personalizzabile e in sviluppo costante.
