...
define("EMOLAN_18", "per favore rinomina le istanze elencate così che non contengano spazi:");
define("EMOLAN_19", "Nome");
define("EMOLAN_20", "Locazione");
define("EMOLAN_21", "Errore");
define("EMOLAN_22", "Trovato nuovo set Faccine:");
define("EMOLAN_23", "Trovato nuovo set Faccine xml:");
define("EMOLAN_24", "Trovato nuovo set Faccine php:");
define("EMOLAN_25", "Installazione nuovo set di faccine PHP: ");
define("EMOLAN_26", "Re-scan set di faccine");
define("EMOLAN_27", "Errore durante la processazione del set: ");
define("EMOLAN_28", "Genera XML");
define("EMOLAN_29", "XML file generato: ");
define("EMOLAN_30", "Errore di scrittura file XML: ");
