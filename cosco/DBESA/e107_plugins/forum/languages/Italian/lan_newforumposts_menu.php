...
define("NFP_6", "Numero di caratteri da visualizzare?");
define("NFP_7", "Suffisso per messaggi troppo lunghi?");
define("NFP_8", "Mostra i messaggi originali nel menù?");
define("NFP_9", "Aggiorna impostazioni");
define("NFP_10", "Menù di configurazione Nuovi Messaggi Forum");
define("NFP_11", "Inviato da: ");
define("NFP_12", "Età massima dei post da visualizzare");
define("NFP_13", "Usa zero per un sito tranquillo; settare un valore in giorni ridurrà il tempo di interrogazione del database per un sito molto attivo.");
