...
define("ONLINE_EL8", "Massimo numero di utenti in linea");
define("ONLINE_EL9", "il");
define("ONLINE_TRACKING_MESSAGE", "Online user tracking attualmente disabilitato, prego attivalo [link=".e_ADMIN."users.php?options]qui[/link][br]");
