...
$NumeroSpan = 5 + (2*NUMEROSTAGES);
        ...
        if ($MyCmd == 'totale'){
              ...
              $querySemiauto = "SELECT * FROM " .$MioNomeGara ." WHERE Divisione='SEMIAUTO' AND Classe='A' ORDER BY TotalePunti DESC";
              ...
              $queryRevolver = "SELECT * FROM " .$MioNomeGara ." WHERE Divisione='REVOLVER' AND Classe='A' ORDER BY TotalePunti DESC";
              ...
              echo "<center><B>SEMIAUTO<BR><BR></B></center>";
              echo "<TABLE BORDER='1'>";

              //CLASSIFICA AUTOMATICA CAT A
              echo "<TR>";
              echo "<TH COLSPAN=" .$NumeroSpan ."><font color='#FFFFFF'><B><center>CLASSE A</center></B></font></TH>";
              echo "</TR>";
              echo "<TR>";
              echo "<TH></TH>";
...
mysql_close($connection);
               ...
               $MyCounter = ($ClassificaR + $ClassificaA + $ClassificaRB + $ClassificaAB + 10) * 1000;
               //echo "" .$MyCounter ."";
