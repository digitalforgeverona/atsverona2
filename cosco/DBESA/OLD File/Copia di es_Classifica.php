...
$NumeroSpan = 5 + (2*NUMEROSTAGES);
        ...
        if ($MyCmd == 'totale'){
              ...
              $querySemiauto = "SELECT ID, Cognome, Nome, " .$MioSelect ." TotalePunti FROM " .$MioNomeGara ." WHERE Divisione='SEMIAUTO' AND Classe='A' ORDER BY TotalePunti DESC";
              ...
              $queryRevolver = "SELECT ID, Cognome, Nome, " .$MioSelect ." TotalePunti FROM " .$MioNomeGara ." WHERE Divisione='REVOLVER' AND Classe='A' ORDER BY TotalePunti DESC";
         ...
         if ($MyCmd == 'definitiva'){
              $MioNomeGara = str_replace(' ', '_', NOMEGARA);
              $querySemiauto = "SELECT ID, Cognome, Nome, " .$MioSelect ." TotalePunti, MAX(TotalePunti) FROM " .$MioNomeGara ." WHERE Divisione='SEMIAUTO' AND Classe='A' GROUP BY Nome, Cognome ORDER BY TotalePunti DESC";
              $resultSemiauto = mysql_query($querySemiauto);
              ...
              $resultSemiautoB = mysql_query($querySemiautoB);
              $queryRevolver = "SELECT ID, Cognome, Nome, " .$MioSelect ." TotalePunti, MAX(TotalePunti) FROM " .$MioNomeGara ." WHERE Divisione='REVOLVER' AND Classe='A' GROUP BY Nome, Cognome ORDER BY TotalePunti DESC";
              $resultRevolver = mysql_query($queryRevolver);
         ...
         if ($MyCmd == 'senior'){
              $MioNomeGara = str_replace(' ', '_', NOMEGARA);
              $querySemiauto = "SELECT ID, Cognome, Nome, " .$MioSelect ." TotalePunti, MAX(TotalePunti) FROM " .$MioNomeGara ." WHERE Divisione='SEMIAUTO' AND Classe='A' AND Senior='1' GROUP BY Nome, Cognome ORDER BY TotalePunti DESC";
              $resultSemiauto = mysql_query($querySemiauto);
              ...
              $resultSemiautoB = mysql_query($querySemiautoB);
              $queryRevolver = "SELECT ID, Cognome, Nome, " .$MioSelect ." TotalePunti, MAX(TotalePunti) FROM " .$MioNomeGara ." WHERE Divisione='REVOLVER' AND Classe='A' AND Senior='1' GROUP BY Nome, Cognome ORDER BY TotalePunti DESC";
              $resultRevolver = mysql_query($queryRevolver);
              ...
              $resultRevolverB = mysql_query($queryRevolverB);
              echo "<center><B>SENIOR</center></B><BR><BR>";
              }
              
         if ($MyCmd == 'esordiente'){
              $MioNomeGara = str_replace(' ', '_', NOMEGARA);
              $querySemiauto = "SELECT ID, Cognome, Nome, " .$MioSelect ." TotalePunti, MAX(TotalePunti) FROM " .$MioNomeGara ." WHERE Divisione='SEMIAUTO' Classe='A' AND Esordiente='1' GROUP BY Nome, Cognome ORDER BY TotalePunti DESC";
              $resultSemiauto = mysql_query($querySemiauto);
              ...
              $resultSemiautoB = mysql_query($querySemiautoB);
              $queryRevolver = "SELECT ID, Cognome, Nome, " .$MioSelect ." TotalePunti, MAX(TotalePunti) FROM " .$MioNomeGara ." WHERE Divisione='REVOLVER' Classe='A' AND Esordiente='1' GROUP BY Nome, Cognome ORDER BY TotalePunti DESC";
              $resultRevolver = mysql_query($queryRevolver);
              ...
              $resultRevolverB = mysql_query($queryRevolverB);
              echo "<center><B>ESORDIENTI</center></B><BR><BR>";
              }
              
         if ($MyCmd == 'lady'){
              $MioNomeGara = str_replace(' ', '_', NOMEGARA);
              $querySemiauto = "SELECT ID, Cognome, Nome, " .$MioSelect ." TotalePunti, MAX(TotalePunti) FROM " .$MioNomeGara ." WHERE Divisione='SEMIAUTO' Classe='A' AND Lady='1' GROUP BY Nome, Cognome ORDER BY TotalePunti DESC";
              $resultSemiauto = mysql_query($querySemiauto);
              ...
              $resultSemiautoB = mysql_query($querySemiautoB);
              $queryRevolver = "SELECT ID, Cognome, Nome, " .$MioSelect ." TotalePunti, MAX(TotalePunti) FROM " .$MioNomeGara ." WHERE Divisione='REVOLVER' Classe='A' AND Lady='1' GROUP BY Nome, Cognome ORDER BY TotalePunti DESC";
              $resultRevolver = mysql_query($queryRevolver);
              ...
              $resultRevolverB = mysql_query($queryRevolverB);
              echo "<center><B>LADY</center></B><BR><BR>";
              }
...
if ($MyPrint == 'Y'){
    ...
    $dataRB = array();
               ...
               while($dataB[] = mysql_fetch_assoc($resultSemiautoB)) {}
                        /*echo("<SCRIPT LANGUAGE='JavaScript'>
                        window.alert('CONTEGGIO: " .count($dataB) ."')
                        </SCRIPT>");*/
                        if (count($dataB)>=1){
        ...
        $pdf->ezTable($data,'','SEMIAUTO A', array('xPos'=>50,'xOrientation'=>'right','width'=>500));
        $pdf->ezText(' ',50);
        $pdf->ezTable($dataB,'','SEMIAUTO B', array('xPos'=>50,'xOrientation'=>'right','width'=>500));
        $pdf->ezText(' ',50);
        $pdf->ezTable($dataR,'','REVOLVER A', array('xPos'=>50,'xOrientation'=>'right','width'=>500));
        $pdf->ezText(' ',50);
...
//NON STAMPA MA MOSTRA A VIDEO
              ...
              echo "<center><B>SEMIAUTO</B><BR></center>";
              echo "<TABLE BORDER='1'>";

              //CLASSIFICA AUTOMATICA CAT A
              echo "<TR>";
              echo "<TH COLSPAN=" .$NumeroSpan ."><B><center>CLASSE A</center></B></TH>";
              echo "</TR>";
              echo "<TR>";
              echo "<TH></TH>";
             ...
             // CLASSIFICA REVOLVER
              echo "<BR><BR><BR>";
              echo "<center><B>REVOLVER</B><BR></center>";
              echo "<TABLE BORDER='1'>";
