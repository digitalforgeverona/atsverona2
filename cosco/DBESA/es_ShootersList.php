...
$db = mysql_select_db("atsveron_dbesa", $connection)
               ...
               $query = "SELECT ID, Cognome, Nome, Classe, Squadra FROM Shooters
               ...
               echo "<FORM METHOD='POST' ACTION='es_ShootersList.php'>";
               ...
               echo "<TH style='width:80px;'>AGGIUNGI<br>A<br>GARA</TH>
                    ...
                    <TH style='width:50px;'>SQUADRA</TH>
...

               {
                   ...
                   echo "<TD bgcolor='#FFFFFF'><center><a href='./es_AggiungiTiratore.php?cmd=add&ID=" .$row['ID'] ."'><img src='extended_16.png' title='Aggiungi Tiratore alla gara'/></a></TD>
                        ...
                        <TD bgcolor='#FFFFFF'><center><a href='./es_ModificaShooter.php?cmd=edit&ID=" .$row['ID'] ."'><img src='edit_16.png' title='Modifica Tiratore'/></a></center></TD>

                        <TD bgcolor='#FFFFFF'><center><a href='./es_ModificaShooter.php?cmd=del&ID=" .$row['ID'] ."'><img src='delete_16.png' title='Elimina Tiratore'/></a></center></TD>";
