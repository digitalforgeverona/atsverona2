...
$db = mysql_select_db("esagonale", $connection);
              ...
              $queryPrestazioni = "SELECT * FROM " .$MioNomeGara ."";
              $resultPrestazioni = mysql_query($queryPrestazioni);
              $NumeroPrestazioni = mysql_num_rows($resultPrestazioni);
              ...
              if ($MyCmd == 'print'){
                   ...
                   $pdf->Write(0, $MiaData);
                   $pdf->SetXY(35, 85);
                   $pdf->Write(0, "TOTALE PRESTAZIONI: " .$NumeroPrestazioni ."");
                   $pdf->SetXY(35, 95);
              ...
              echo "TOTALE PRESTAZIONI: " .$NumeroPrestazioni ."<BR><BR>";
