...
define("LAN_head_2", "Il tuo server non permette il caricamento files via HTTP; sarà impossibile per i tuoi utenti caricare avatars/files etc. Per risolvere questa situazione devi impostare file_uploads to On nel file php.ini e riavviare il tuo server. Se non hai accesso al file php.ini, contatta il tuo hosts.");
