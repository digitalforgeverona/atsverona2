...
switch($custom_query[0])
{
		...
		case "login noprofile":
				...
				if (USER == TRUE){
						$ret .= "<span class='ciao'><span class='loginc welcome'></span>".$sep."<br />";
						if(ADMIN == TRUE){
								$ret .= "<a href='".e_ADMIN."admin.php'><img src='".THEME."images/admin.gif'/>&nbsp;".LOGIN_MENU_L11."</a> ".$sep." ";
						}
						$ret .= ($custom_query[0] != "login noprofile") ? "<a class='loginc profile' href='".e_BASE."user.php?id.".USERID."'><img src='".THEME."images/profilo.gif'/>&nbsp;".LOGIN_MENU_L13."</a>\n &nbsp;&nbsp;":"";
						$ret .= "<a class='loginc usersettings' href='" . e_BASE . "usersettings.php'><img src='".THEME."images/modprof.gif'/>&nbsp;".LOGIN_MENU_L12."</a>&nbsp;&nbsp;<a class='loginc logout' href='".e_BASE."index.php?logout'><img src='".THEME."images/logout.gif'/>&nbsp;".LOGIN_MENU_L8."</a> ".$sep."</span>";
				} else {
						...
						if($pref['user_reg'])
						{
							$ret .= "<br /><br />Non sei ancora registrato?&nbsp;<a rel='shadowbox' class='loginc signup' title='Pagina di Registrazione' href='".e_SIGNUP."'>".LOGIN_MENU_L3."&nbsp;adesso!</a>";
						}
						$ret .= "</span>\n</form>";
				}
				return $ret;
