...
|
|     $Source: /cvsroot/e107/e107_0.7/e107_themes/jayya/forum/forum_icons_template.php,v $
|     $Revision: 1.4 $
...
define("IMAGE_new_popular_small", "<img src='".img_path('new_popular.gif')."' alt='".FORLAN_13."' title='".FORLAN_13."' style='border:0' />");
define("IMAGE_nonew_popular_small", "<img src='".img_path('nonew_popular.gif')."' alt='".FORLAN_14."' title='".FORLAN_14."' style='border:0' />");
