...
$FORUM_VIEW_START = "
	...
	<table style='".USER_WIDTH."' class='fborder'>
	<tr>
	<td style='width:3%' class='forumheader6'>&nbsp;</td>
	<td style='width:47%' class='forumheader7'>{THREADTITLE}</td>
	<td style='width:20%; text-align:center' class='forumheader7'>{STARTERTITLE}</td>
	<td style='width:5%; text-align:center' class='forumheader7'>{REPLYTITLE}</td>
	<td style='width:5%; text-align:center' class='forumheader7'>{VIEWTITLE}</td>
	<td style='width:20%; text-align:center' class='forumheader7'>{LASTPOSTITLE}</td>
	</tr>";
}
