...
define("LAN_417", "L'amministratore sarà avvisato di questa discussione. Puoi scivere un messaggio spiegando le ragioni delle tue obiezioni.");
define("LAN_418", "<b>ATTENZIONE: NO</b> usare questo modulo per contattare l'amministrazione con altre motivazioni.");
define("LAN_419", "Invia segnalazione");
define("LAN_420", "Premi per vedere il messaggio");
define("LAN_421", "Messaggio segnalato da");
define("LAN_422", "Questo messaggio è stato segnalato dal sito ");
define("LAN_423", "Il messaggio non può essere inviato. ");
define("LAN_424", "Il messaggio è stato segnalato al moderatore e all'amministratore.<br />Grazie.");
define("LAN_425", "Messaggio da: ");
define("LAN_426", "Segnalazione messaggio nella disussione: ");
define("LAN_427", "Errore inviando la mail");
define("LAN_428", "Il messaggio è stato segnalato");
...
define("LAN_431", "Syndicate questa discussione: rss 0.92");
define("LAN_432", "Syndicate questa discussione: rss 2.0");
define("LAN_433", "Syndicate questa discussione: RDF");
