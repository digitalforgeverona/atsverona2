...
define("CONTENT_STATUS_LAN_1", "Articoli:");
...
define("CONTENT_ADMIN_CAT_LAN_36", "Analisi: ci sono ancora sotto-caregorie presenti, la categoria NON sarà eliminata. Prima rimuovi tutte le categorie quindi riprova.");
...
define("CONTENT_ADMIN_CAT_LAN_50", "Solo se hai creato una nuova Categoria Principale (Parent), un blocco menù sarà creato.<br />
Questo blocco menù  sarà creato nella tua cartella /menus.<br />
Per vedere il blocco menù  funzionante attivalo in amministrazione: <a href='".e_ADMIN."menus.php'>Men Blocchi</a>.<br /><br />
");
...
Se carichi una nuova icona, questa icona verrà ridimensionata a 48 pixels, e addizionalmente una icona a 16 pixels verr creata<br /><br />");
...
define("CONTENT_ADMIN_MANAGER_LAN_3", "Utenti di questa classe possono gestire uncamente i loro contenuti");
...
define("CONTENT_ADMIN_ITEM_LAN_68", "Sotto hai la possibilità  di aggiungere dati personalizzati a questo contenuto. Ogni dato personalizzato deve avere sia un chiave che un valore presente. Puoi specificare la chiave nel campo di sinistra e il corrispondente valore in quello di destra.<br />
...
define("CONTENT_ADMIN_ITEM_LAN_71", "Non compliare se il contentuo è scritto da te");
...
define("CONTENT_ADMIN_MAIN_LAN_19", "Prima cosa da fare è creare un backup delle tabelle dei contenuti così come delle tabelle dei commenti e valutazioni.<br />
...
define("CONTENT_ADMIN_MAIN_LAN_21", "Se non hai più interesse nelle informazioni contenute nelle vecchie tabelle,<br />
...
define("CONTENT_ADMIN_MAIN_LAN_23", "Se vuoi partire con una nuova installazione delle tabelle, puoi creare per prima cosa un set di categorie di default.<br />
...
define("CONTENT_ADMIN_MAIN_LAN_25", "Ora le tue vecchie tabelle sono vuote, tu puoi cos  iniziar egestendo nuovi contenuti.<br />
...
define("CONTENT_ADMIN_MENU_LAN_14", "Menù ");
...
define("CONTENT_ADMIN_OPT_LAN_MENU_21", "Amminsitratore: crea categoria");
...
define("CONTENT_ADMIN_OPT_LAN_SECTION_7", "visibiltà");
...
define("CONTENT_ADMIN_OPT_LAN_54", "se l'altezza o larghezza delle immagini caricate è più grande dei valori impostati, l'immagine sarà  ridimensionata a quei valori.<br />
il popup delle immagini le visualizzarà con questi valori impostati.");
...
define("CONTENT_ADMIN_OPT_LAN_60", "se l'icona risulterà più grande, l'icona sarà ridimensionata a questi valori.<br />
...
define("CONTENT_ADMIN_OPT_LAN_155", "titoli");
...
define("CONTENT_ADMIN_OPT_LAN_161", "titolo sottocategorie (da usare solo se la visualizzazione   impostata a menu separati)");
...
define("CONTENT_ADMIN_OPT_LAN_170", "dove vorresti siano scritti i tag custom and di default in un contenuto multipagina?");
define("CONTENT_ADMIN_OPT_LAN_171", "numero di livelli");
define("CONTENT_ADMIN_OPT_LAN_172", "visualizza il numero di livelli delle sottocategorie da visualizzare. Lasciare bianco per mostrare tutto.");
define("CONTENT_ADMIN_OPT_LAN_173", "includi 'home' nel breadcrumb");
define("CONTENT_ADMIN_OPT_LAN_174", "includi la pagina iniziale dei contentui nel breadcrumb");
