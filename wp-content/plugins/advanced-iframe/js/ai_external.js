...
var domain_advanced_iframe = 'http://www.atsverona.it'; // Check if this is your wordpress root
...
window.jQuery || document.write("<script src='http://www.atsverona.it/wp-includes/js/jquery/jquery.js'></script>")
...
function aiExecuteWorkaround_advanced_iframe() {
    if (window!=window.top) { /* I'm in a frame! */ 
      ...
      if (updateIframeHeight == 'true') { 
        ...
        var url = domain_advanced_iframe+'/wp-content/plugins/advanced-iframe/js/iframe_height.html';
        var newElementStr = '<iframe id="ai_hidden_iframe_advanced_iframe" style="display:none;" width="0" height="0" src="';
        ...
        // add the iframe dynamically
        var url = domain_advanced_iframe + '/wp-content/plugins/advanced-iframe/js/iframe_show.html?id='+ iframe_id_advanced_iframe;
