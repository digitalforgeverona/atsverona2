<?php
/*
 * Template Name: Modern Portfolio Page 3 Column
 */
get_header();
        ...
        <div class="row">
            ...
            <div id="portfolio_filter_options" class="col-md-12 filters">
                ...
                if (have_posts()) :
                    ...
                    <div class="portfolio_items col-md-12 clearfix"><ul class="row main_content clearfix thumbnails" id="portfolio_container">
	
                    <?php while (have_posts()) : the_post(); ?>
                            <!-- then add the current post thumbnail with proper rel to use in jquery intro sliding -->
                            <li class=" portfolio_element clearfix col-md-4 modern_project_thumbnail portfoliotagfilterall <?php echo asalah_portfolio_tag(); ?>">
