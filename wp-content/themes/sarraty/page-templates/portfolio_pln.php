<?php
/*
 * Template Name: Modern Portfolio Paluanilife
 */
get_header();
...
<div class="site_content">
    ...
    <div class="container portfolio_page">
        <div class="row">
            ...
            <div id="portfolio_filter_options" class="col-md-12 filters clearfix">
            ...
            <!-- start main content div -->
				...
				$pln_tag = asalah_post_option('pln_tag');
				
				//echo "TAG: " .$pln_tag;
                
				$wp_query = new WP_Query(array('post_type' => 'project', 'posts_per_page' => $per_page, 'paged' => get_query_var('paged'), 'tagportfolio' => $pln_tag));
                ...
                if (have_posts()) :
                    ...
                    <?php while (have_posts()) : the_post(); ?>
                            ...
                            <li class=" portfolio_element clearfix col-md-3 modern_project_thumbnail portfoliotagfilterall <?php echo asalah_portfolio_tag(); ?>">
