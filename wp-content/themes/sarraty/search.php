...
<div class="site_content">
    ...
    <?php if (asalah_option("asalah_enable_pagetitle")): ?>
        <div class="page_title_holder clearfix">
            <div class="container">
                <div class="page_info">
                    <h1 class="title"><?php printf( __( 'Search Results for: %s', 'asalah' ), get_search_query() ); ?></h1>
        ...
        <div class="row">
            <div class="col-md-9 main_content">
                <?php if (have_posts()) : ?>
                    ...
                    <?php if (!asalah_option("asalah_enable_pagetitle")): ?>
                        <h1 class="title secondary_page_title"><?php printf( __( 'Search Results for: %s', 'asalah' ), get_search_query() ); ?></h1>
                    <?php endif; ?>
