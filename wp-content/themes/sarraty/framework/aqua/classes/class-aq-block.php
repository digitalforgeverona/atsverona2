	...
	class AQ_Block {
	 	...
	 	function before_block($instance) {
	 		...
	 		$column_class = $first ? 'aq-first' : '';
                        $cols = str_replace('span', '', $size);
			if ($missedlast == true) {
				if (isset($thewidth) && $thewidth == 'fluid' && $size == 'span12') {
					echo '</div></div>';
				}else{
					echo '</div></div>';
				}
	 		...
	 		if ($first == true) {
				if (isset($thewidth) && $thewidth == 'fluid' && $size == 'span12') {
				echo '<div class="container content_container fullwidth-aq-block fullwidth_'.$id_base.'"><div class="row">';
				}else{
				echo '<div class="container content_container"><div class="row">';
				}
			}
	 		echo '<div id="aq-block-'.$number.'" class="aq-block  aq-block-'.$id_base.' col-md-'.$cols.' '.$class.' '.$column_class.' cf">';
	 	}
	 	
	 	/* block footer */
	 	function after_block($instance) {
                        if (isset($last)  && $column_end == $last ) {
                            $column_end = "aq-last";
                        }else{
                            $column_end = "";
                        }
