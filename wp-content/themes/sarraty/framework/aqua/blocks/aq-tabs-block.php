...
if (!class_exists('AQ_Tabs_Block')) {
    ...
    class AQ_Tabs_Block extends AQ_Block {
        ...
        function block($instance) {
            ...
            if ($type == 'tab') {
                $i = 1;
                $output .= '<div class="horizontal_tab"><ul id="tab' . $number . '" class="nav nav-tabs">';
                foreach ($tabs as $tab) {
                ...
                foreach ($tabs as $tab) {
                    ...
                    $output .= '<div class="tab-pane ' . $tab_selected . ' in" id="tabcontent' . $number . '_' . $i . '">';
                ...
                $output .= '<div class="panel-group" id="accordion' . $number . '">';
                ...
                foreach ($tabs as $tab) {
                    ...
                    $output .= '<div id="collapse_' . $number . '_' . $i . '" class="panel-collapse collapse ' . $tab_selected . '">';
