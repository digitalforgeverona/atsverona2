...
if(class_exists('AQ_Page_Builder')) {
	...
	********************************************************/
	...
	/* Input field - Options: $size = min, small, full */
	function aq_field_color($field_id, $block_id, $input, $size = 'full', $type = 'text') {
		$output = '<input type="'.$type.'" id="'. $block_id .'_'.$field_id.'" class="asalah_color input-'.$size.'" value="'.$input.'" name="aq_blocks['.$block_id.']['.$field_id.']">';
