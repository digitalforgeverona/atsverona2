...
include_once( ABSPATH . 'wp-admin/includes/plugin.php' ); // For check plugin active
...
*
*/
if ( !class_exists( 'ReduxFramework' ) && file_exists( dirname( __FILE__ ) . '/admin/wmfauracore/ReduxCore/framework.php' ) ) {
    require_once( dirname( __FILE__ ) . '/admin/wmfauracore/ReduxCore/framework.php' );
}
...
function add_auramainmenu_code () {
	if (!is_admin()) {
		...
		//global $post;
		//$thePostID = $post->ID;
		//_menu_item_iconbgcolor _menu_item_iconbgopacity
		//_menu_item_iconbordercolor _menu_item_iconborderopacity
		//_menu_item_icontextcolor
