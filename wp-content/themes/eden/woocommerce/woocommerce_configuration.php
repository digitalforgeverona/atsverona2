...
function woo_custom_add_to_cart_message() {
    ...
    if (get_option('woocommerce_cart_redirect_after_add')=='yes') :
        ...
        $message 	= sprintf('<h3>%s</h3><a href="%s" class="qbutton normal_button">%s<i class="fa fa-shopping-cart fa-lg" style=""></i></a> ', __('Product(s) successfully added to your cart.', 'woocommerce'), get_permalink(woocommerce_get_page_id('cart')), __('View Cart', 'woocommerce'));
