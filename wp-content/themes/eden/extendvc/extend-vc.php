...
vc_add_param("vc_row", array(
	...
	"value" => array("Use video background?" => "show_video"),
	"param_name" => "video",
	"description" => "",
	"dependency" => Array('element' => "row_type", 'value' => array('row'))
));
vc_add_param("vc_row", array(
	...
	"value" => array("Use transparent overlay over video?" => "show_video_overlay" ),
...
vc_add_param("vc_separator", array(
	...
	"value" => array(
		...
		"Full width"	  =>  "full_width",
		"Small"			  =>  "small",
		"Small with Icon" =>  "small_with_icon"
	),
	"description" => ""
));
...
vc_add_param("vc_separator", array(
	"type" => "textfield",
	"class" => "",
	"heading" => "Small Separator Width (%)",
	"param_name" => "small_width",
	"value" => "",
	"dependency" => array("element" => "type", "value" => array("small", "small_with_icon"))
));
...
vc_add_param("vc_separator", array(
	"type" => "colorpicker",
	"class" => "",
	"heading" => "Circle Background Color",
...
vc_add_param("vc_separator", array(
	...
	"value" => $icons,
	"description" => "",
	"dependency" => array("element" => "type", "value" => array("small_with_icon"))
));
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => "Company Position/Website Color",
            ...
            array(
                ...
                "holder" => "div",
                "class" => "",
                "heading" => "Control navigation",
                "param_name" => "control_navigation",
                "value" => array(
                    "No" => "without_control",
                    "Yes" => "with_control"
                )
            ...
            array(
                ...
                "holder" => "div",
                "class" => "",
                "heading" => "Control navigation color",
                "param_name" => "control_navigation_color",
                "value" => array(
                    "Gray" => "gray_control",
                    "White" => "white_control"
                ),
				"dependency" => array("element" => "control_navigation", "value" => array("with_control"))
            )
		)
) );
...
vc_map( array(
		...
		"params" => array(
			array(
				...
				"value" => array(
					"Standard" => "standard",
					"Standard Dark Style" => "standard_dark_style",
					"Gallery" => "hover_text",
					"Gallery Without Space" => "hover_text_no_space"				
				),
				"description" => ""
			),
			array(
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => "Digit Color on End",
				"param_name" => "digit_color_end",
				"description" => ""
			),
			array(
				"type" => "textfield",
		...
		"params" => array(
			array(
				...
				"value" => array(
					"Normal" => "normal",
					"With Icon" => "with_icon",
                    "Centered (without columns)" => "centered"
				),
				"description" => ""
			),
			array(
            ...
            array(
                ...
                "description" => "",
                "dependency" => array('element' => 'show_button', 'value' => array('yes'), 'element' => 'type', 'value' => array('normal','with_icon'))
            ),
			array(
				"type" => "textfield",
				"holder" => "div",
		...
		"params" => array(
			array(
				...
				"value" => array(
					...
					"Normal With Icon Animation" => "normal_button_icon",
                    "Transparent" => "transparent_button",
                    "Stript" => "stript_button",
				),
				"description" => ""
			),
			array(
				...
				"value" => array(
					...
					"Medium" => "medium",	
					"Large" => "large",
					"Full Width" => "big_large_full_width"
				),
				"description" => ""
			),
			array(
			...
			array(
				...
				"param_name" => "icon",
				"value" => $icons,
				"dependency" => array('element' => "type", 'value' => array('normal_button','transparent_button', 'normal_button_icon'))
			),
			array(
				"type" => "colorpicker",
				"holder" => "div",
            ...
            array(
                ...
                "param_name" => "background_color",
                "description" => "",
                "dependency" => array('element' => "type", 'value' => array('normal_button', 'normal_button_icon'))
            ),
			array(
				"type" => "colorpicker",
				"holder" => "div",
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => "Title Top Border Color",
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => "Show Title Bottom Border",
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => "Background Transparency",
				"param_name" => "transparency",
				"value" => "",
				"description" => "From 0 to 1 (Example 0.7)",
				"dependency" => Array('element' => "type", 'value' => array('circle_social', 'square_social'))
			),
			array(
				"type" => "colorpicker",
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => "Background Hover Transparency",
				"param_name" => "transparency_hover",
				"value" => "",
				"description" => "From 0 to 1 (Example 0.7)",
				"dependency" => Array('element' => "type", 'value' => array('circle_social', 'square_social'))
			)
...
// Icon with Text - Elegant
vc_map( array(
		"name" => "Icon With Text - Elegant",
		"base" => "icon_text_elegant",
		"icon" => "icon-wpb-icon_text_elegant",
		"category" => 'by QODE',
		"allowed_container_element" => 'vc_row',
		"params" => array(
			array(
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => "Separator Between Title and Text",
				"param_name" => "separator",
				"value" => array(
					"Yes" => "yes",
					"No"  => "no"
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => "Boxes Background Color",
				"param_name" => "background_color",
				"description" => "",
				"dependency" => Array('element' => "type", 'value' => array('boxes'))
			),
...
class WPBakeryShortCode_Qode_Icons_List_Text  extends WPBakeryShortCodesContainer {}
//Register "container" content element. It will hold all your inner (child) content elements
vc_map( array(
        "name" => "Qode Icons List With Text Holder", "qode",
        "base" => "qode_icons_list_text",
        "as_parent" => array('only' => 'qode_icon_list_text'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
        "content_element" => true,
		"category" => 'by QODE',
		"icon" => "icon-wpb-qode_icons_list_text",
        "show_settings_on_create" => true,
        "params" => array(
            array(
                "type" => "dropdown",
...
class WPBakeryShortCode_Qode_Icon_List_Text extends WPBakeryShortCode {}
vc_map( array(
        "name" => "Qode Icon List With Text", "qode",
        "base" => "qode_icon_list_text",
        "content_element" => true,
		"icon" => "icon-wpb-qode_icon_list_text",
        "as_child" => array('only' => 'qode_icons_list_text'), // Use only|except attributes to limit parent (separate multiple values with comma)
        "params" => array(
        	array(
				"type" => "dropdown",
				"holder" => "div",
			...
			array(
				"type" => "dropdown",
				"class" => "",
				"heading" => "Line between Circles",
				"param_name" => "line_between_circles",
				"value" => array(
                    "No"   => "no_line",
					"Yes" => "with_line",
				)
			...
			array(
				...
				"param_name" => "icon_animation_delay",
				"value" => "",
                "dependency" => array('element' => "icon_animation", 'not_empty' => true)
			),
        	array(
				"type" => "dropdown",
				"class" => "",
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => "Icon/Text Background Color",
				"param_name" => "background_color"
			),
			array(
				"type" => "colorpicker",
				"holder" => "div",
				"class" => "",
				"heading" => "Icon/Text Border Color",
				"param_name" => "border_color"
			),
			array(
                "type" => "textfield",
...
//Register "container" content element. It will hold all your inner (child) content elements
vc_map( array(
        "name" => "Qode Pricing Table Holder", "qode",
        ...
        "content_element" => true,
		"category" => 'by QODE',
		"icon" => "icon-wpb-qode_pricing_tables",
        "show_settings_on_create" => true,
        "params" => array(
            array(
                "type" => "dropdown",
                "holder" => "div",
                "class" => "",
                "heading" => "Numbers of Pricing Table Items",
                "param_name" => "number",
                "value" => array(
                	"One"   => "one_column",
                    "Two"   => "two_columns",
...
vc_map( array(
        "name" => "Qode Pricing Table", "qode",
        "base" => "qode_pricing_table",
        "content_element" => true,
		"icon" => "icon-wpb-qode_pricing_table",
        ...
        "params" => array(
			...
			array(
				...
				"heading" => "Currency",
				"param_name" => "currency",
				"description" => "Default currency is $"
			),
			array(
				"type" => "textfield",
				"holder" => "div",
				...
				"description" => "Default price period is /mo"
			),
			array(
				"type" => "attach_image",
				"holder" => "div",
...
class WPBakeryShortCode_Qode_Progress_Bars_Vertical  extends WPBakeryShortCodesContainer {}
//Register "container" content element. It will hold all your inner (child) content elements
vc_map( array(
        "name" => "Qode Progress Bars Vertical Holder", "qode",
        "base" => "qode_progress_bars_vertical",
        "as_parent" => array('only' => 'qode_progress_bar_vertical'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
        "content_element" => true,
		"category" => 'by QODE',
        ...
        "params" => array(
            array(
                ...
                "holder" => "div",
                "class" => "",
                "heading" => "Numbers of Progress Bar Items",
                "param_name" => "number",
                "value" => array(
                	"One"   => "one_item",
                    "Two"   => "two_items",
...
class WPBakeryShortCode_Qode_Progress_Bar_Vertical extends WPBakeryShortCode {}
vc_map( array(
        "name" => "Qode Progress Bar Vertical", "qode",
        "base" => "qode_progress_bar_vertical",
        "content_element" => true,
		"icon" => "icon-wpb-vertical_progress_bar",
        "as_child" => array('only' => 'qode_progress_bars_vertical'), // Use only|except attributes to limit parent (separate multiple values with comma)
        "params" => array(
        	array (
				"type" => "textfield",
				"holder" => "div",
