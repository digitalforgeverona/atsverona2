...
if (isset($qode_options_eden['lightbox_single_project'])) 
	$lightbox_single_project = $qode_options_eden['lightbox_single_project'];
...
}elseif(isset($qode_options_eden['portfolio_style'])){
	if($qode_options_eden['portfolio_style'] == 1){
		$porftolio_template = 1;
	}elseif($qode_options_eden['portfolio_style'] == 2){
		$porftolio_template = 2;
	}elseif($qode_options_eden['portfolio_style'] == 3){
		$porftolio_template = 3;
	}elseif($qode_options_eden['portfolio_style'] == 4){
		$porftolio_template = 4;
	}elseif($qode_options_eden['portfolio_style'] == 5){
		$porftolio_template = 5;
	}elseif($qode_options_eden['portfolio_style'] == 6){
		$porftolio_template = 6;
	}elseif($qode_options_eden['portfolio_style'] == 7){
		$porftolio_template = 7;
	}
}
...
if(get_post_meta(get_the_ID(), "qode_choose-number-of-portfolio-columns", true) != ""){
	...
	if(isset($qode_options_eden['portfolio_columns_number'])){
		if($qode_options_eden['portfolio_columns_number'] == 2){
			$columns_number = "v2";
		} else if($qode_options_eden['portfolio_columns_number'] == 3) {
			$columns_number = "v3";
		} else if($qode_options_eden['portfolio_columns_number'] == 4) {
			$columns_number = "v4";
		}
	}
}
...
if(get_post_meta(get_the_ID(), "qode_show-portfolio-categories", true) != ""){
	...
	if(isset($qode_options_eden['portfolio_categories']) && $qode_options_eden['portfolio_categories'] != ""){
		$porftolio_categories = $qode_options_eden['portfolio_categories'];
	}
}
?>
...
<?php get_header(); ?>
	<?php if (have_posts()) : ?>
		<?php while (have_posts()) : the_post(); ?>
				...
				<div class="container"<?php if($content_style != "") { echo " style='". $content_style ."'";} ?>>
					<div class="container_inner clearfix">
						<div class="portfolio_single">
							...
							<?php 
								get_template_part('templates/portfolio/portfolio_navigation', 'loop');
							?>
			...
			<?php switch ($porftolio_template) {
				case 7: ?>		
					<div class="full_width"<?php if($content_style != "") { echo " style='". $content_style ."'";} ?>>
