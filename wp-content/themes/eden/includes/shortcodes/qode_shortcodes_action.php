    ...
    <form id="qode_shortcode_form" name="qode_shortcode_form" method="post" action="">
		...
		<div class="input">
            ...
            <select name="icon_size" id="icon_size">
                ...
                <option value="fa-4x">Very Large</option>
            </select>
        </div>
		 <div class="input">
        ...
        <div class="input">
            <label>Text Left Padding (px)</label>
            <input name="text_left_padding" id="text_left_padding" value="" size="12" />
        </div>
		<div class="input">
        ...
        <div class="input">
            ...
            <select name="button_position" id="button_position">
                <option value=""></option>
                <option value="left_position">Left</option>
                <option value="center_position">Center</option>
                <option value="right_position">Right</option>
            </select>
        </div>
        <div class="input">
