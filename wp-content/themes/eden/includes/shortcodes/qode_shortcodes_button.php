    ...
    <form id="qode_shortcode_form" name="qode_shortcode_form" method="post" action="">
        <div class="input">
            ...
            <select name="type" id="type">
                <option value="normal_button">Normal</option>
                <option value="normal_button_icon">Normal With Icon Animation</option>
                <option value="transparent_button">Transparent</option>
                <option value="stript_button">Stript</option>
            </select>
        </div>            
        <div class="input">
            <label>Size</label>
            <select name="size" id="size">
                ...
                <option value="big_large_full_width">Full Width</option>
            </select>
        </div>
        <div class="input">
            <label>Text</label>
