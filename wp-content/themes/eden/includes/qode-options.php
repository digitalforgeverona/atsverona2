...
$qode_options_eden  = get_option('qode_options_eden');
...
class Qode_Theme_Options {
	...
	function init_qode_theme_options() {
		global $qode_options_eden;
		if(isset($qode_options_eden['reset_to_defaults'])){ 
			if( $qode_options_eden['reset_to_defaults'] == 'yes' ) delete_option( "qode_options_eden");
		}
		if (! get_option("qode_options_eden")) {
			add_option( "qode_options_eden",
				array(
					"reset_to_defaults" => '',
					"number_of_chars" => 45,
					"first_color" => '',
	...
	function register_qode_theme_settings() {
	    register_setting( 'qode_options_eden_page', 'qode_options_eden', array(&$this, 'validate_options') );
	}
	/*** Add Option to admin sidebar ***/
	function qode_admin_menu() {
		$this->init_qode_theme_options();
		$this->pagehook = add_menu_page('Qode Theme', esc_html__('Qode Options', 'qode'), 'manage_options', 'qode_options_eden_page', array(&$this, 'qode_generate_options_page'));
	...
	function qode_generate_options_page() {
		...
		global $screen_layout_columns, $qode_options_eden;
...
<?php			settings_fields( 'qode_options_eden_page' );
				$options = get_option('qode_options_eden');
...
<?php					    do_meta_boxes($this->pagehook, 'additional', $options); ?>
						...
						<label for="reset_to_defaults">
						    <input name="qode_options_eden[reset_to_defaults]" type="checkbox" id="reset_to_defaults" value="yes" />
...
<?php	}
	...
	global $qode_options_eden;
		$input['number_of_chars'] = is_numeric( $input['number_of_chars'] ) ? absint($input['number_of_chars']) : $qode_options_eden['number_of_chars'];
		return $input;
	}
		...
		<div class="sections">
					...
					<tbody>
						<tr valign="top">
							...
							<td>
								<div>
									...
									<input name="qode_options_eden[first_color]" type="text" value="<?php if ($options['first_color']) { echo esc_attr($options['first_color'], 'qode'); } ?>" size="30" maxlength="100" />
									<?php esc_html_e('Default text color', 'qode'); ?>
									<div class="inline" style="vertical-align:middle; margin: 0 10px;"><span style="width: 20px; height: 20px; display: inline-block; background-color: #00c6ff;" title="#00c6ff"></span></div>
								</div>
								<br/>
								<div>
									<?php esc_html_e('Area color', 'qode'); ?>
									<div class="colorSelector"><div style="<?php if ($options['first_area_color']){ echo 'background-color:'.esc_attr($options['first_area_color'], 'qode').';'; } ?>"></div></div>
									<input name="qode_options_eden[first_area_color]" type="text" value="<?php if (isset($options['first_area_color'])) { echo esc_attr($options['first_area_color'], 'qode'); } ?>" size="30" maxlength="100" />
									<?php esc_html_e('Default area color', 'qode'); ?>
									<div class="inline" style="vertical-align:middle; margin: 0 10px;"><span style="width: 20px; height: 20px; display: inline-block; background-color: #00c6ff;" title="#00c6ff"></span></div>
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div>
									...
									<input name="qode_options_eden[second_color]" type="text" value="<?php if ($options['second_color']) { echo esc_attr($options['second_color'], 'qode'); } ?>" size="30" maxlength="100" />
									<?php esc_html_e('Default second main color', 'qode'); ?>
									<div class="inline" style="vertical-align:middle; margin: 0 10px;"><span style="width: 20px; height: 20px; display: inline-block; background-color: #222;" title="#222"></span></div>
								</div>
								<br/>
								<div>
									<?php esc_html_e('Area color', 'qode'); ?>
									<div class="colorSelector"><div style="<?php if ($options['second_area_color']){ echo 'background-color:'.esc_attr($options['second_area_color'], 'qode').';'; } ?>"></div></div>
									<input name="qode_options_eden[second_area_color]" type="text" value="<?php if (isset($options['second_area_color'])) { echo esc_attr($options['second_area_color'], 'qode'); } ?>" size="30" maxlength="100" />
									<?php esc_html_e('Default area color', 'qode'); ?>
									<div class="inline" style="vertical-align:middle; margin: 0 10px;"><span style="width: 20px; height: 20px; display: inline-block; background-color: #222;" title="#222"></span></div>
								</div>
							</td>
						...
						<tr valign="middle">
							...
							<td>
								...
								<input name="qode_options_eden[background_color]" type="text" value="<?php if ($options['background_color']) { echo esc_attr($options['background_color'], 'qode'); } ?>" size="30" maxlength="500" />
								<?php esc_html_e('Default background color', 'qode'); ?>
								<div class="inline" style="vertical-align:middle; margin: 0 0 0 10px;"><span style="width: 20px; height: 20px; display: inline-block; border: 1px solid #e0dede; background-color: #F4F4F4;" title="#F4F4F4"></span></div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								...
								<input name="qode_options_eden[background_color_box]" type="text" value="<?php if (isset($options['background_color_box'])) { echo esc_attr($options['background_color_box'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
							...
							<td>
								...
								<input name="qode_options_eden[background_color_boxes]" type="text" value="<?php if (isset($options['background_color_boxes'])) { echo esc_attr($options['background_color_boxes'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
							...
							<td>
								...
								<input name="qode_options_eden[highlight_color]" type="text"  value="<?php if ($options['highlight_color']) { echo esc_attr($options['highlight_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
							...
							<td>
								...
								<input name="qode_options_eden[selection_color]" type="text"  value="<?php if ($options['selection_color']) { echo esc_attr($options['selection_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
							...
							<td>
								...
								<input type="text" id="background_image" name="qode_options_eden[background_image]" class="background_image" value="<?php if (isset($options['background_image'])) { echo esc_attr($options['background_image'], 'qode'); } ?>" size="70">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline" style="width: 705px;">
								<input type="text" id="pattern_background_image" name="qode_options_eden[pattern_background_image]" class="pattern_background_image" value="<?php if (isset($options['pattern_background_image'])) { echo esc_attr($options['pattern_background_image'], 'qode'); } ?>" size="70">
								<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline" style="width: 705px;">
								<input type="text" id="favicon_image" name="qode_options_eden[favicon_image]" class="favicon_image" value="<?php if ($options['favicon_image']) { echo esc_attr($options['favicon_image'], 'qode'); } else { echo QODE_ROOT."/img/favicon.ico"; } ?>" size="70">
								<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="middle">
								...
								<td>
							<select name="qode_options_eden[google_fonts]">
						...
						<tr valign="middle">
								...
								<td>
							<select name="qode_options_eden[page_transitions]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[boxed]">
						...
						<tr valign="middle">
								...
								<td>
									<select name="qode_options_eden[loading_animation]">
										<option <?php if (isset($options['loading_animation'])){ $loading_animation = $options['loading_animation']; if ($loading_animation == 'yes') { echo "selected='selected'"; } } ?> value="yes">Yes</option>
										<option <?php if (isset($options['loading_animation'])){ $loading_animation = $options['loading_animation']; if ($loading_animation == 'no') { echo "selected='selected'"; } } ?> value="no">No</option>
									</select>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[smooth_scroll]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[responsiveness]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[show_back_button]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[elements_animation_on_touch]">
						...
						<tr valign="middle">
							...
							<td>
								<input name="qode_options_eden[google_analytics_code]" type="text" value="<?php if (isset($options['google_analytics_code'])) { echo esc_attr($options['google_analytics_code'], 'qode'); } ?>" size="63" maxlength="500" />
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="internal_no_ajax_links" name="qode_options_eden[internal_no_ajax_links]" cols="60" rows="5"><?php if (isset($options['internal_no_ajax_links'])) { echo esc_attr($options['internal_no_ajax_links'], 'qode'); } ?></textarea>
								</div>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="custom_css" name="qode_options_eden[custom_css]" cols="60" rows="5"><?php if ($options['custom_css']) { echo esc_attr($options['custom_css'], 'qode'); } ?></textarea>
								</div>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="custom_js" name="qode_options_eden[custom_js]" cols="60" rows="5"><?php if ($options['custom_js']) { echo esc_attr($options['custom_js'], 'qode'); } ?></textarea>
								</div><br/>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="meta_keywords" name="qode_options_eden[meta_keywords]" cols="60" rows="5"><?php if ($options['meta_keywords']) { echo esc_attr($options['meta_keywords'], 'qode'); } ?></textarea>
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="meta_description" name="qode_options_eden[meta_description]" cols="60" rows="5"><?php if ($options['meta_description']) { echo esc_attr($options['meta_description'], 'qode'); } ?></textarea>
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<select name="qode_options_eden[disable_qode_seo]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[h1_color]" type="text" value="<?php if ($options['h1_color']) { echo esc_attr($options['h1_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[h1_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
								...
								<div class="inline">
									...
									<input name="qode_options_eden[h1_fontsize]" type="text" value="<?php if ($options['h1_fontsize']) { echo esc_attr($options['h1_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_eden[h1_lineheight]" type="text" value="<?php if ($options['h1_lineheight']) { echo esc_attr($options['h1_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_eden[h1_fontstyle]">
								...
								<div class="inline">
									...
									<select name="qode_options_eden[h1_fontweight]">
								...
								<div class="inline">
									...
									<input name="qode_options_eden[h1_letterspacing]" type="text" value="<?php if (isset($options['h1_letterspacing']) && $options['h1_letterspacing']) { echo esc_attr($options['h1_letterspacing'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[h2_color]" type="text" value="<?php if ($options['h2_color']) { echo esc_attr($options['h2_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[h2_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_eden[h2_fontsize]" type="text" value="<?php if ($options['h2_fontsize']) { echo esc_attr($options['h2_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_eden[h2_lineheight]" type="text" value="<?php if ($options['h2_lineheight']) { echo esc_attr($options['h2_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_eden[h2_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_eden[h2_fontweight]">
								...
								<div class="inline">
									<?php esc_html_e('Letter spacing (px)', 'qode'); ?>
									<input name="qode_options_eden[h2_letterspacing]" type="text" value="<?php if (isset($options['h2_letterspacing']) && $options['h2_letterspacing']) { echo esc_attr($options['h2_letterspacing'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[h3_color]" type="text" value="<?php if ($options['h3_color']) { echo esc_attr($options['h3_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[h3_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_eden[h3_fontsize]" type="text" value="<?php if ($options['h3_fontsize']) { echo esc_attr($options['h3_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_eden[h3_lineheight]" type="text" value="<?php if ($options['h3_lineheight']) { echo esc_attr($options['h3_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_eden[h3_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_eden[h3_fontweight]">
								...
								<div class="inline">
									<?php esc_html_e('Letter spacing (px)', 'qode'); ?>
									<input name="qode_options_eden[h3_letterspacing]" type="text" value="<?php if (isset($options['h3_letterspacing']) && $options['h3_letterspacing']) { echo esc_attr($options['h3_letterspacing'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[h4_color]" type="text" value="<?php if ($options['h4_color']) { echo esc_attr($options['h4_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[h4_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_eden[h4_fontsize]" type="text" value="<?php if ($options['h4_fontsize']) { echo esc_attr($options['h4_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_eden[h4_lineheight]" type="text" value="<?php if ($options['h4_lineheight']) { echo esc_attr($options['h4_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_eden[h4_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_eden[h4_fontweight]">
								...
								<div class="inline">
									<?php esc_html_e('Letter spacing (px)', 'qode'); ?>
									<input name="qode_options_eden[h4_letterspacing]" type="text" value="<?php if (isset($options['h4_letterspacing']) && $options['h4_letterspacing']) { echo esc_attr($options['h4_letterspacing'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[h5_color]" type="text" value="<?php if ($options['h5_color']) { echo esc_attr($options['h5_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[h5_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_eden[h5_fontsize]" type="text" value="<?php if ($options['h5_fontsize']) { echo esc_attr($options['h5_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_eden[h5_lineheight]" type="text" value="<?php if ($options['h5_lineheight']) { echo esc_attr($options['h5_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_eden[h5_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_eden[h5_fontweight]">
								...
								<div class="inline">
									<?php esc_html_e('Letter spacing (px)', 'qode'); ?>
									<input name="qode_options_eden[h5_letterspacing]" type="text" value="<?php if (isset($options['h5_letterspacing']) && $options['h5_letterspacing']) { echo esc_attr($options['h5_letterspacing'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[h6_color]" type="text" value="<?php if ($options['h6_color']) { echo esc_attr($options['h6_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[h6_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_eden[h6_fontsize]" type="text" value="<?php if ($options['h6_fontsize']) { echo esc_attr($options['h6_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_eden[h6_lineheight]" type="text" value="<?php if ($options['h6_lineheight']) { echo esc_attr($options['h6_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_eden[h6_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_eden[h6_fontweight]">
								...
								<div class="inline">
									<?php esc_html_e('Letter spacing (px)', 'qode'); ?>
									<input name="qode_options_eden[h6_letterspacing]" type="text" value="<?php if (isset($options['h6_letterspacing']) && $options['h6_letterspacing']) { echo esc_attr($options['h6_letterspacing'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_eden[text_color]" type="text" value="<?php if ($options['text_color']) { echo esc_attr($options['text_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_eden[text_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?>
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_eden[text_fontsize]" type="text" value="<?php if ($options['text_fontsize']) { echo esc_attr($options['text_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_eden[text_lineheight]" type="text" value="<?php if ($options['text_lineheight']) { echo esc_attr($options['text_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_eden[text_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_eden[text_fontweight]">
									...
									<div class="inline">
										...
										<input name="qode_options_eden[text_margin]" type="text" value="<?php if (isset($options['text_margin'])) { echo esc_attr($options['text_margin'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
								</td>
						</tr>
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_eden[link_color]" type="text" value="<?php if ($options['link_color']) { echo esc_attr($options['link_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										...
										<input name="qode_options_eden[link_hovercolor]" type="text" value="<?php if ($options['link_hovercolor']) { echo esc_attr($options['link_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_eden[link_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_eden[link_fontweight]">
									...
									<div class="inline">
										...
										<select name="qode_options_eden[link_fontdecoration]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[page_title_color]" type="text" value="<?php if ($options['page_title_color']) { echo esc_attr($options['page_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[page_title_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_eden[page_title_fontsize]" type="text" value="<?php if ($options['page_title_fontsize']) { echo esc_attr($options['page_title_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_eden[page_title_lineheight]" type="text" value="<?php if ($options['page_title_lineheight']) { echo esc_attr($options['page_title_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_eden[page_title_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_eden[page_title_fontweight]">
				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[header_in_grid]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[header_top_area]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[header_top_area_scroll]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[enable_breadcrumbs]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[enable_search]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[header_bottom_appearance]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[header_style]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[menu_position]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[header_top_background_color]" type="text" value="<?php if (isset($options['header_top_background_color'])) { echo esc_attr($options['header_top_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[header_background_color]" type="text" value="<?php if (isset($options['header_background_color'])) { echo esc_attr($options['header_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									...
									<input name="qode_options_eden[header_background_color_scroll]" type="text" value="<?php if (isset($options['header_background_color_scroll'])) { echo esc_attr($options['header_background_color_scroll'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									...
									<input name="qode_options_eden[header_background_color_sticky]" type="text" value="<?php if (isset($options['header_background_color_sticky'])) { echo esc_attr($options['header_background_color_sticky'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[header_separator_color]" type="text" value="<?php if (isset($options['header_separator_color'])) { echo esc_attr($options['header_separator_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="inline">
									<?php esc_html_e('Initial', 'qode'); ?>
									<input name="qode_options_eden[header_background_transparency_initial]" type="text" value="<?php if (isset($options['header_background_transparency_initial'])) { echo esc_attr($options['header_background_transparency_initial'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Scrolled (fixed style)', 'qode'); ?>
									<input name="qode_options_eden[header_background_transparency_scroll]" type="text" value="<?php if (isset($options['header_background_transparency_scroll'])) { echo esc_attr($options['header_background_transparency_scroll'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Sticky', 'qode'); ?>
									<input name="qode_options_eden[header_background_transparency_sticky]" type="text" value="<?php if (isset($options['header_background_transparency_sticky'])) { echo esc_attr($options['header_background_transparency_sticky'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Border Initial', 'qode'); ?>
									<input name="qode_options_eden[header_border_transparency_initial]" type="text" value="<?php if (isset($options['header_border_transparency_initial'])) { echo esc_attr($options['header_border_transparency_initial'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline" style="width: 700px;">
									...
									<input type="text" id="logo_image" name="qode_options_eden[logo_image]" class="logo_image" value="<?php if (isset($options['logo_image'])) { echo esc_attr($options['logo_image'], 'qode'); } else { echo QODE_ROOT."/img/logo.png"; } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div><br/><br/>
								<div class="inline" style="width: 700px;">
									<?php esc_html_e('Logo image - light', 'qode'); ?><br/>
									<input type="text" id="logo_image_light" name="qode_options_eden[logo_image_light]" class="logo_image_light" value="<?php if (isset($options['logo_image_light'])) { echo esc_attr($options['logo_image_light'], 'qode'); } else { echo QODE_ROOT."/img/logo.png"; } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div><br/><br/>
								<div class="inline" style="width: 700px;">
									<?php esc_html_e('Logo image - dark', 'qode'); ?><br/>
									<input type="text" id="logo_image_dark" name="qode_options_eden[logo_image_dark]" class="logo_image_dark" value="<?php if (isset($options['logo_image_dark'])) { echo esc_attr($options['logo_image_dark'], 'qode'); } else { echo QODE_ROOT."/img/logo_black.png"; } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div><br/><br/>
								<div class="inline"style="width: 700px;">
									<?php esc_html_e('Logo image - sticky header', 'qode'); ?><br/>
									<input type="text" id="logo_image_sticky" name="qode_options_eden[logo_image_sticky]" class="logo_image_sticky" value="<?php if (isset($options['logo_image_sticky'])) { echo esc_attr($options['logo_image_sticky'], 'qode'); } else { echo QODE_ROOT."/img/logo_black.png"; } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[center_logo_image]">
						...
						<tr valign="top">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_eden[header_height]" type="text" value="<?php if (isset($options['header_height'])) { echo esc_attr($options['header_height'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Scrolled - fixed style (px)', 'qode'); ?>
										<input name="qode_options_eden[header_height_scroll]" type="text" value="<?php if (isset($options['header_height_scroll'])) { echo esc_attr($options['header_height_scroll'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Sticky (px)', 'qode'); ?>
										<input name="qode_options_eden[header_height_sticky]" type="text" value="<?php if (isset($options['header_height_sticky'])) { echo esc_attr($options['header_height_sticky'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
								</td>
						</tr>
						<tr valign="top">
								...
								<td>
									<div class="inline">
										<input name="qode_options_eden[scroll_amount_for_sticky]" type="text" value="<?php if (isset($options['scroll_amount_for_sticky'])) { echo esc_attr($options['scroll_amount_for_sticky'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
								</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[dropdown_background_color]" type="text" value="<?php if (isset($options['dropdown_background_color'])) { echo esc_attr($options['dropdown_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Item background hover color', 'qode'); ?>
									<div class="colorSelector"><div style="<?php if (isset($options['item_background_hover_color'])){ echo 'background-color:'.esc_attr($options['item_background_hover_color'], 'qode').';'; } ?>"></div></div>
									<input name="qode_options_eden[item_background_hover_color]" type="text" value="<?php if (isset($options['item_background_hover_color'])) { echo esc_attr($options['item_background_hover_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Transparency (From 0 to 1)', 'qode'); ?>
									<input name="qode_options_eden[dropdown_background_transparency]" type="text" value="<?php if (isset($options['dropdown_background_transparency'])) { echo esc_attr($options['dropdown_background_transparency'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[menu_color]" type="text" value="<?php if ($options['menu_color']) { echo esc_attr($options['menu_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									...
									<input name="qode_options_eden[menu_hovercolor]" type="text" value="<?php if (isset($options['menu_hovercolor'])) { echo esc_attr($options['menu_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[menu_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_eden[menu_fontsize]" type="text" value="<?php if ($options['menu_fontsize']) { echo esc_attr($options['menu_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_eden[menu_lineheight]" type="text" value="<?php if ($options['menu_lineheight']) { echo esc_attr($options['menu_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_eden[menu_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_eden[menu_fontweight]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[dropdown_color]" type="text" value="<?php if (isset($options['dropdown_color'])) { echo esc_attr($options['dropdown_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover/Active color', 'qode'); ?>
									...
									<input name="qode_options_eden[dropdown_hovercolor]" type="text" value="<?php if (isset($options['dropdown_hovercolor'])) { echo esc_attr($options['dropdown_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[dropdown_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_eden[dropdown_fontsize]" type="text" value="<?php if ($options['dropdown_fontsize']) { echo esc_attr($options['dropdown_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_eden[dropdown_lineheight]" type="text" value="<?php if ($options['dropdown_lineheight']) { echo esc_attr($options['dropdown_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_eden[dropdown_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_eden[dropdown_fontweight]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[dropdown_color_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_color_thirdlvl'])) { echo esc_attr($options['dropdown_color_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover/Active color', 'qode'); ?>
									...
									<input name="qode_options_eden[dropdown_hovercolor_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_hovercolor_thirdlvl'])) { echo esc_attr($options['dropdown_hovercolor_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[dropdown_google_fonts_thirdlvl]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_eden[dropdown_fontsize_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_fontsize_thirdlvl'])) { echo esc_attr($options['dropdown_fontsize_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_eden[dropdown_lineheight_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_lineheight_thirdlvl'])) { echo esc_attr($options['dropdown_lineheight_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_eden[dropdown_fontstyle_thirdlvl]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_eden[dropdown_fontweight_thirdlvl]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[fixed_color]" type="text" value="<?php if (isset($options['fixed_color'])) { echo esc_attr($options['fixed_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover/Active color', 'qode'); ?>
									...
									<input name="qode_options_eden[fixed_hovercolor]" type="text" value="<?php if (isset($options['fixed_hovercolor'])) { echo esc_attr($options['fixed_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[fixed_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_eden[fixed_fontsize]" type="text" value="<?php if (isset($options['fixed_fontsize'])) { echo esc_attr($options['fixed_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_eden[fixed_lineheight]" type="text" value="<?php if (isset($options['fixed_lineheight'])) { echo esc_attr($options['fixed_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_eden[fixed_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_eden[fixed_fontweight]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[sticky_color]" type="text" value="<?php if (isset($options['sticky_color'])) { echo esc_attr($options['sticky_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover/Active color', 'qode'); ?>
									...
									<input name="qode_options_eden[sticky_hovercolor]" type="text" value="<?php if (isset($options['sticky_hovercolor'])) { echo esc_attr($options['sticky_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[sticky_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_eden[sticky_fontsize]" type="text" value="<?php if (isset($options['sticky_fontsize'])) { echo esc_attr($options['sticky_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_eden[sticky_lineheight]" type="text" value="<?php if (isset($options['sticky_lineheight'])) { echo esc_attr($options['sticky_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_eden[sticky_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_eden[sticky_fontweight]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[mobile_color]" type="text" value="<?php if (isset($options['mobile_color'])) { echo esc_attr($options['mobile_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover/Active color', 'qode'); ?>
									...
									<input name="qode_options_eden[mobile_hovercolor]" type="text" value="<?php if (isset($options['mobile_hovercolor'])) { echo esc_attr($options['mobile_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[mobile_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_eden[mobile_fontsize]" type="text" value="<?php if (isset($options['mobile_fontsize'])) { echo esc_attr($options['mobile_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_eden[mobile_lineheight]" type="text" value="<?php if (isset($options['mobile_lineheight'])) { echo esc_attr($options['mobile_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_eden[mobile_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_eden[mobile_fontweight]">
									...
									<div class="inline">
										...
										<input name="qode_options_eden[mobile_separator_color]" type="text" value="<?php if (isset($options['mobile_separator_color'])) { echo esc_attr($options['mobile_separator_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Background color', 'qode'); ?>
										...
										<input name="qode_options_eden[mobile_background_color]" type="text" value="<?php if (isset($options['mobile_background_color'])) { echo esc_attr($options['mobile_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Letter spacing (px)', 'qode'); ?>
										<input name="qode_options_eden[mobile_letter_spacing]" type="text" value="<?php if (isset($options['mobile_letter_spacing'])) { echo esc_attr($options['mobile_letter_spacing'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_eden[animate_title_area]">
								...
								<div class="inline">
									...
									<select name="qode_options_eden[title_text_shadow]">
								...
								<div class="inline">
									...
									<input name="qode_options_eden[title_background_color]" type="text" value="<?php if (isset($options['title_background_color'])) { echo esc_attr($options['title_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<br/><br/>
								<div class="inline">
									<?php esc_html_e('Responsive title image', 'qode'); ?>
									<select name="qode_options_eden[responsive_title_image]">
								...
								<div class="inline">
									...
									<select name="qode_options_eden[fixed_title_image]">
								...
								<div class="inline" style="width: 780px;">
									...
									<input type="text" id="title_image" name="qode_options_eden[title_image]" class="title_image" value="<?php if (isset($options['title_image'])) { echo esc_attr($options['title_image'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
								<br/><br/>
								<div class="inline" style="width: 880px;">
									<?php esc_html_e('Title pattern overlay image', 'qode'); ?>
									<input type="text" id="title_overlay_image" name="qode_options_eden[title_overlay_image]" class="title_overlay_image" value="<?php if (isset($options['title_overlay_image'])) { echo esc_attr($options['title_overlay_image'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
								<br/><br/>
								<div class="inline">
									<?php esc_html_e('Title height (px)', 'qode'); ?>
									<input name="qode_options_eden[title_height]" type="text" value="<?php if (isset($options['title_height'])) { echo esc_attr($options['title_height'], 'qode'); } ?>" size="10" maxlength="10" />
									<?php esc_html_e('Only if title image is not responsive', 'qode'); ?>
								</div>
								<br/><br/>
								<div class="inline">
									<?php esc_html_e('Title position', 'qode'); ?>
									<select name="qode_options_eden[page_title_position]">
										<option <?php if ($options['page_title_position'] == 'left') { echo "selected='selected'"; } ?> value="left">Left</option>
										<option <?php if ($options['page_title_position'] == 'left_image') { echo "selected='selected'"; } ?> value="left_image">Left with image</option>
										<option <?php if ($options['page_title_position'] == 'left_large') { echo "selected='selected'"; } ?> value="left_large">Left large title</option>
								...
								<div class="inline">
									...
									<select name="qode_options_eden[predefined_title_sizes]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[uncovering_footer]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[footer_in_grid]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[show_footer_top]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[footer_top_columns]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[footer_text]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[footer_separator_color]" type="text" value="<?php if (isset($options['footer_separator_color']) && $options['footer_separator_color']) { echo esc_attr($options['footer_separator_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[footer_top_title_color]" type="text" value="<?php if ($options['footer_top_title_color']) { echo esc_attr($options['footer_top_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Text color', 'qode'); ?>
									...
									<input name="qode_options_eden[footer_top_text_color]" type="text" value="<?php if ($options['footer_top_text_color']) { echo esc_attr($options['footer_top_text_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									...
									<input name="qode_options_eden[footer_link_color]" type="text" value="<?php if (isset($options['footer_link_color'])) { echo esc_attr($options['footer_link_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									...
									<input name="qode_options_eden[footer_link_hover_color]" type="text" value="<?php if (isset($options['footer_link_hover_color'])){ echo esc_attr($options['footer_link_hover_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Background color', 'qode'); ?>
									...
									<input name="qode_options_eden[footer_top_background_color]" type="text" value="<?php if ($options['footer_top_background_color']) { echo esc_attr($options['footer_top_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[footer_bottom_text_color]" type="text" value="<?php if ($options['footer_bottom_text_color']) { echo esc_attr($options['footer_bottom_text_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Background color', 'qode'); ?>
									...
									<input name="qode_options_eden[footer_bottom_background_color]" type="text" value="<?php if (isset($options['footer_bottom_background_color'])) { echo esc_attr($options['footer_bottom_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
					</tbody>
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[separator_color]" type="text" value="<?php if (isset($options['separator_color'])) { echo esc_attr($options['separator_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Thickness (px)', 'qode'); ?>
									<input name="qode_options_eden[separator_thickness]" type="text" value="<?php if ($options['separator_thickness']) { echo esc_attr($options['separator_thickness'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Top margin (px)', 'qode'); ?>
									<input name="qode_options_eden[separator_topmargin]" type="text" value="<?php if ($options['separator_topmargin']) { echo esc_attr($options['separator_topmargin'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Bottom margin (px)', 'qode'); ?>
									<input name="qode_options_eden[separator_bottommargin]" type="text" value="<?php if ($options['separator_bottommargin']) { echo esc_attr($options['separator_bottommargin'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[button_title_color]" type="text" value="<?php if ($options['button_title_color']) { echo esc_attr($options['button_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover color', 'qode'); ?>
									...
									<input name="qode_options_eden[button_title_hovercolor]" type="text" value="<?php if ($options['button_title_hovercolor']) { echo esc_attr($options['button_title_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[button_title_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_eden[button_title_fontsize]" type="text" value="<?php if ($options['button_title_fontsize']) { echo esc_attr($options['button_title_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_eden[button_title_lineheight]" type="text" value="<?php if ($options['button_title_lineheight']) { echo esc_attr($options['button_title_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_eden[button_title_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_eden[button_title_fontweight]">
								...
								<div class="inline">
									...
									<input name="qode_options_eden[button_backgroundcolor_hover]" type="text" value="<?php if (isset($options['button_backgroundcolor_hover']) && $options['button_backgroundcolor_hover']) { echo esc_attr($options['button_backgroundcolor_hover'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[message_title_color]" type="text" value="<?php if ($options['message_title_color']) { echo esc_attr($options['message_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_eden[message_title_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?>
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_eden[message_title_fontsize]" type="text" value="<?php if ($options['message_title_fontsize']) { echo esc_attr($options['message_title_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_eden[message_title_lineheight]" type="text" value="<?php if ($options['message_title_lineheight']) { echo esc_attr($options['message_title_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_eden[message_title_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_eden[message_title_fontweight]">
								...
								<div class="inline">
									...
									<input name="qode_options_eden[message_backgroundcolor]" type="text" value="<?php if ($options['message_backgroundcolor']) { echo esc_attr($options['message_backgroundcolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									...
									<input name="qode_options_eden[message_bordercolor]" type="text" value="<?php if (isset($options['message_bordercolor']) && $options['message_bordercolor']) { echo esc_attr($options['message_bordercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[message_icon_color]" type="text" value="<?php if (isset($options['message_icon_color']) && $options['message_icon_color']) { echo esc_attr($options['message_icon_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_eden[message_icon_fontsize]" type="text" value="<?php if (isset($options['message_icon_fontsize']) && $options['message_icon_fontsize']) { echo esc_attr($options['message_icon_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[blockquote_font_color]" type="text" value="<?php if ($options['blockquote_font_color']) { echo esc_attr($options['blockquote_font_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Background Color', 'qode'); ?>
									...
									<input name="qode_options_eden[blockquote_background_color]" type="text" value="<?php if (isset($options['blockquote_background_color']) &&  $options['blockquote_background_color']) { echo esc_attr($options['blockquote_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Border Color', 'qode'); ?>
									...
									<input name="qode_options_eden[blockquote_border_color]" type="text" value="<?php if (isset($options['blockquote_border_color']) &&  $options['blockquote_border_color']) { echo esc_attr($options['blockquote_border_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
                                <div class="inline">
									...
									<input name="qode_options_eden[blockquote_quote_icon_color]" type="text" value="<?php if (isset($options['blockquote_quote_icon_color']) &&  $options['blockquote_quote_icon_color']) { echo esc_attr($options['blockquote_quote_icon_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
					</tbody>
				...
				<table class="form-table">
					<tbody>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[enable_side_area]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<input name="qode_options_eden[side_area_title]" type="text" value="<?php if(isset($options['side_area_title'])) { if ($options['side_area_title']) { echo esc_attr($options['side_area_title'], 'qode'); } } ?>" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[side_area_background_color]" type="text" value="<?php if(isset($options['side_area_background_color'])){ if ($options['side_area_background_color']) { echo esc_attr($options['side_area_background_color'], 'qode'); } } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[side_area_text_color]" type="text" value="<?php if(isset($options['side_area_text_color'])){ if ($options['side_area_text_color']) { echo esc_attr($options['side_area_text_color'], 'qode'); } } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[side_area_title_color]" type="text" value="<?php if(isset($options['side_area_title_color'])){ if ($options['side_area_title_color']) { echo esc_attr($options['side_area_title_color'], 'qode'); } } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
					</tbody>
				...
				<table class="form-table">
					<tbody>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[enable_content_bottom_area]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[content_bottom_sidebar_custom_display]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[content_bottom_in_grid]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[content_bottom_background_color]" type="text" value="<?php if(isset($options['content_bottom_background_color'])){ if ($options['content_bottom_background_color']) { echo esc_attr($options['content_bottom_background_color'], 'qode'); } } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
					</tbody>
				...
				<table class="form-table">
					<tbody>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[parallax_onoff]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<input name="qode_options_eden[parallax_minheight]" type="text" value="<?php if ($options['parallax_minheight']) { echo esc_attr($options['parallax_minheight'], 'qode'); } ?>" size="10" maxlength="10" />
				...
				<table class="form-table">
					<tbody>
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[portfolio_style]">
						...
						<tr valign="middle">
								...
								<td>
									<select name="qode_options_eden[portfolio_qode_like]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[lightbox_single_project]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_eden[portfolio_columns_number]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<input name="qode_options_eden[portfolio_single_slug]" type="text" value="<?php if (isset($options['portfolio_single_slug']) && $options['portfolio_single_slug'] != "") { echo esc_attr($options['portfolio_single_slug'], 'qode'); } ?>" />
						...
						<tr>
							<td valign="middle" width="150"><?php esc_html_e('Show categories', 'qode'); ?></td>
							<td>
								<div class="inline">
									<select name="qode_options_eden[portfolio_categories]">
										...
										<option <?php if(isset($options['portfolio_categories'])){ $portfolio_categories = $options['portfolio_categories']; if ($portfolio_categories == 'no') { echo "selected='selected'"; } }  ?> value="no">No</option>
										<option <?php if(isset($options['portfolio_categories'])){ $portfolio_categories = $options['portfolio_categories']; if ($portfolio_categories == 'yes') { echo "selected='selected'"; } } ?> value="yes">Yes</option>
									</select>
								</div>
							</td>
						</tr>
					...
					<tbody>
						<tr valign="middle">
							...
							<td>
								...
								<input name="qode_options_eden[blog_quote_link_box_color]" type="text" value="<?php if (isset($options['blog_quote_link_box_color']) && $options['blog_quote_link_box_color']) { echo esc_attr($options['blog_quote_link_box_color'], 'qode'); } ?>" size="10" maxlength="10" />
								<?php esc_html_e('For Large Image and Large Image Full Content type', 'qode'); ?>
							</td>
						</tr>
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[pagination]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[blog_style]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[category_blog_sidebar]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[blog_hide_comments]">
						...
						<tr valign="middle">
								...
								<td>
									<select name="qode_options_eden[qode_like]">
						...
						<tr valign="middle">
							...
							<td>
								<input name="qode_options_eden[blog_page_range]" type="text" value="<?php if (isset($options['blog_page_range']) && $options['blog_page_range']) { echo esc_attr($options['blog_page_range'], 'qode'); } ?>" size="10" maxlength="10" />
							</td>
						</tr>
						<tr valign="middle">
							<td scope="row" width="150"><?php esc_html_e('Number of words', 'qode'); ?></td>
							<td>
								<input name="qode_options_eden[number_of_chars]" type="text" value="<?php if (isset($options['number_of_chars']) && $options['number_of_chars']) { echo esc_attr($options['number_of_chars'], 'qode'); } ?>" size="10" maxlength="10" />
						...
						<tr valign="middle">
							...
							<td>
								<input name="qode_options_eden[number_of_chars_masonry]" type="text" value="<?php if (isset($options['number_of_chars_masonry']) && $options['number_of_chars_masonry']) { echo esc_attr($options['number_of_chars_masonry'], 'qode'); } ?>" size="10" maxlength="10" />
							</td>
						</tr>
						<tr valign="middle">
							<td scope="row" width="150"><?php esc_html_e('Number of words in large image blog template', 'qode'); ?></td>
							<td>
								<input name="qode_options_eden[number_of_chars_large_image]" type="text" value="<?php if (isset($options['number_of_chars_large_image']) && $options['number_of_chars_large_image']) { echo esc_attr($options['number_of_chars_large_image'], 'qode'); } ?>" size="10" maxlength="10" />
							</td>
						</tr><tr valign="middle">
							<td scope="row" width="150"><?php esc_html_e('Number of words in small image blog template', 'qode'); ?></td>
							<td>
								<input name="qode_options_eden[number_of_chars_small_image]" type="text" value="<?php if (isset($options['number_of_chars_small_image'])) { echo esc_attr($options['number_of_chars_small_image'], 'qode'); } ?>" size="10" maxlength="10" />
							</td>
						</tr>
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[blog_single_sidebar]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[blog_single_sidebar_custom_display]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_eden[blog_author_info]">
				...
				<table class="form-table">
					<tbody>
						<tr valign="top">
							...
							<td>
								<input name="qode_options_eden[receive_mail]" type="text" value="<?php if ($options['receive_mail']) { echo esc_attr($options['receive_mail'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Enable Contact Form', 'qode'); ?></td>
							<td>
								<select name="qode_options_eden[enable_contact_form]">
						...
						<tr valign="top">
							...
							<td>
								<select name="qode_options_eden[hide_contact_form_website]">
						...
						<tr valign="top">
							...
							<td>
								<input name="qode_options_eden[email_from]" type="text" value="<?php if ($options['email_from']) { echo esc_attr($options['email_from'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Email Subject', 'qode'); ?></td>
							<td>
								<input name="qode_options_eden[email_subject]" type="text" value="<?php if ($options['email_subject']) { echo esc_attr($options['email_subject'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Use reCaptcha', 'qode'); ?></td>
							<td>
								<select name="qode_options_eden[use_recaptcha]">
						...
						<tr valign="top">
							...
							<td>
								<input name="qode_options_eden[recaptcha_public_key]" type="text" value="<?php if ($options['recaptcha_public_key']) { echo esc_attr($options['recaptcha_public_key'], 'qode'); } ?>"  />
						...
						<tr valign="top">
							...
							<td>
								<input name="qode_options_eden[recaptcha_private_key]" type="text" value="<?php if ($options['recaptcha_private_key']) { echo esc_attr($options['recaptcha_private_key'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Heading above contact form', 'qode'); ?></td>
							<td>
								<input name="qode_options_eden[contact_heading_above]" type="text" value="<?php if ($options['contact_heading_above']) { echo esc_attr($options['contact_heading_above'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Enable Google Map', 'qode'); ?></td>
							<td>
								<select name="qode_options_eden[enable_google_map]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline" style="width: 705px;">
								<input type="text" id="google_maps_pin_image" name="qode_options_eden[google_maps_pin_image]" class="google_maps_pin_image" value="<?php if (isset($options['google_maps_pin_image'])) { echo esc_attr($options['google_maps_pin_image'], 'qode'); } else { echo QODE_ROOT."/img/pin.png"; } ?>" size="70">
								<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<input id="google_maps_address" name="qode_options_eden[google_maps_address]" value="<?php if (isset($options['google_maps_address'])) { echo esc_attr($options['google_maps_address'], 'qode'); } ?>" size="130" />
						...
						<tr valign="top">
							...
							<td>
								<input id="google_maps_address2" name="qode_options_eden[google_maps_address2]" value="<?php if (isset($options['google_maps_address2'])) { echo esc_attr($options['google_maps_address2'], 'qode'); } ?>" size="130" />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Google map address 3', 'qode'); ?></td>
							<td>
								<input id="google_maps_address3" name="qode_options_eden[google_maps_address3]" value="<?php if (isset($options['google_maps_address3'])) { echo esc_attr($options['google_maps_address3'], 'qode'); } ?>" size="130" />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Google map address 4', 'qode'); ?></td>
							<td>
								<input id="google_maps_address4" name="qode_options_eden[google_maps_address4]" value="<?php if (isset($options['google_maps_address4'])) { echo esc_attr($options['google_maps_address4'], 'qode'); } ?>" size="130" />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Google map address 5', 'qode'); ?></td>
							<td>
								<input id="google_maps_address5" name="qode_options_eden[google_maps_address5]" value="<?php if (isset($options['google_maps_address5'])) { echo esc_attr($options['google_maps_address5'], 'qode'); } ?>" size="130" />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Google map zoom', 'qode'); ?></td>
							<td>
								<input id="google_maps_zoom" name="qode_options_eden[google_maps_zoom]" value="<?php if (isset($options['google_maps_zoom'])) { echo esc_attr($options['google_maps_zoom'], 'qode'); } ?>" size="10" maxlength="10" />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Google map height (px)', 'qode'); ?></td>
							<td>
								<input id="google_maps_height" name="qode_options_eden[google_maps_height]" value="<?php if (isset($options['google_maps_height'])) { echo esc_attr($options['google_maps_height'], 'qode'); } ?>" size="10" maxlength="10" />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Google map style', 'qode'); ?></td>
							<td>
								<select name="qode_options_eden[google_maps_style]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_eden[google_maps_color]" type="text" value="<?php if(isset($options['google_maps_color'])){ if ($options['google_maps_color']) { echo esc_attr($options['google_maps_color'], 'qode'); } } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<select name="qode_options_eden[google_maps_scroll_wheel]">
				...
				<table class="form-table">
					<tbody>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Title', 'qode'); ?></td>
							<td>
								<input name="qode_options_eden[404_title]" type="text" value="<?php if ($options['404_title']) { echo esc_attr($options['404_title'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Subtitle', 'qode'); ?></td>
							<td>
								<input name="qode_options_eden[404_subtitle]" type="text" value="<?php if (isset($options['404_subtitle']) && $options['404_subtitle']) { echo esc_attr($options['404_subtitle'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Text', 'qode'); ?></td>
							<td>
								<input name="qode_options_eden[404_text]" type="text" value="<?php if ($options['404_text']) { echo esc_attr($options['404_text'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Back to home label', 'qode'); ?></td>
							<td>
								<input name="qode_options_eden[404_backlabel]" type="text" value="<?php if ($options['404_backlabel']) { echo esc_attr($options['404_backlabel'], 'qode'); } ?>"  />
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="form-table">
					<tbody>
						<tr valign="top">
							...
							<td>
								<select name="qode_options_eden[enable_social_share]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_eden[enable_facebook_share]">
								...
								<div class="inline" style="width: 780px;">
									...
									<input type="text" id="facebook_icon" name="qode_options_eden[facebook_icon]" class="facebook_icon" value="<?php if (isset($options['facebook_icon'])) { echo esc_attr($options['facebook_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_eden[enable_twitter_share]">
								...
								<div class="inline" style="width: 780px;">
									<?php esc_html_e('Share Icon', 'qode'); ?>
									<input type="text" id="twitter_icon" name="qode_options_eden[twitter_icon]" class="twitter_icon" value="<?php if (isset($options['twitter_icon'])) { echo esc_attr($options['twitter_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
								<div class="inline">
									<?php esc_html_e('Via', 'qode'); ?>
									<input name="qode_options_eden[twitter_via]" type="text" value="<?php if (isset($options['twitter_via'])) { echo esc_attr($options['twitter_via'], 'qode'); } ?>"  />
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_eden[enable_google_plus]">
								...
								<div class="inline" style="width: 780px;">
									<?php esc_html_e('Share Icon', 'qode'); ?>
									<input type="text" id="google_plus_icon" name="qode_options_eden[google_plus_icon]" class="google_plus_icon" value="<?php if (isset($options['google_plus_icon'])) { echo esc_attr($options['google_plus_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_eden[enable_linkedin]">
								...
								<div class="inline" style="width: 780px;">
									<?php esc_html_e('Share Icon', 'qode'); ?>
									<input type="text" id="linkedin_icon" name="qode_options_eden[linkedin_icon]" class="linkedin_icon" value="<?php if (isset($options['linkedin_icon'])) { echo esc_attr($options['linkedin_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_eden[enable_tumblr]">
								...
								<div class="inline" style="width: 780px;">
									...
									<input type="text" id="tumblr_icon" name="qode_options_eden[tumblr_icon]" class="tumblr_icon" value="<?php if (isset($options['tumblr_icon'])) { echo esc_attr($options['tumblr_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_eden[enable_pinterest]">
								...
								<div class="inline" style="width: 780px;">
									...
									<input type="text" id="pinterest_icon" name="qode_options_eden[pinterest_icon]" class="pinterest_icon" value="<?php if (isset($options['pinterest_icon'])) { echo esc_attr($options['pinterest_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_eden[enable_vk]">
								...
								<div class="inline" style="width: 780px;">
									...
									<input type="text" id="vk_icon" name="qode_options_eden[vk_icon]" class="vk_icon" value="<?php if (isset($options['vk_icon'])) { echo esc_attr($options['vk_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<?php
								...
								foreach ($post_types as $post_type ) {
									...
									?>
								 <input type="checkbox" value="<?php echo $post_type; ?>" <?php if (isset($options["post_types_names_$post_type"]) && ($options["post_types_names_$post_type"] == "$post_type")){ echo "checked='checked'"; }?> name="qode_options_eden[post_types_names_<?php echo $post_type; ?>]" /><?php echo " " . $post_type_object->labels->singular_name;  ?><br /><br />
			...
			<div>
				<table class="form-table">
					<tbody>
						<tr valign="middle">
							<td scope="row" width="170"><?php esc_html_e('Content Top Padding (px)', 'qode'); ?></td>
							<td>
								<div class="inline">
									<input name="qode_options_eden[woocommerce_content_top_padding]" type="text" value="<?php if(isset($options['woocommerce_content_top_padding'])) { if ($options['woocommerce_content_top_padding']) { echo esc_attr($options['woocommerce_content_top_padding'], 'qode'); } } ?>" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							<td scope="row" width="170"><?php esc_html_e('Single Product Content Top Padding (px)', 'qode'); ?></td>
							<td>
								<div class="inline">
									<input name="qode_options_eden[woocommerce_single_content_top_padding]" type="text" value="<?php if(isset($options['woocommerce_single_content_top_padding'])) { if ($options['woocommerce_single_content_top_padding']) { echo esc_attr($options['woocommerce_single_content_top_padding'], 'qode'); } } ?>" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							<td scope="row" width="170"><?php esc_html_e('Hide Title for Single Product', 'qode'); ?></td>
							<td>
								<div class="inline">
									<select name="qode_options_eden[woocommerce_single_hide_title]">
										<option <?php if(isset($options['woocommerce_single_hide_title'])){ $woo_single_hide_title = $options['woocommerce_single_hide_title']; if ($woo_single_hide_title == "no") { echo "selected='selected'"; } } ?> value="no">No</option>
										<option <?php if(isset($options['woocommerce_single_hide_title'])){ $woo_single_hide_title = $options['woocommerce_single_hide_title']; if ($woo_single_hide_title == "yes") { echo "selected='selected'"; } } ?> value="yes">Yes</option>
									</select>
								</div>
							</td>	
						</tr>
...
if(isset($qode_toolbar)):
  if(!session_id()) {
	...
	if (isset($_SESSION['qode_eden_header_type'])) {
		if ($_SESSION['qode_eden_header_type'] == "big") {
			$qode_options_eden["header_bottom_appearance"] = "stick menu_bottom";
		}
	}
	if (isset($_SESSION['qode_eden_page_transitions'])) {
		$qode_options_eden["page_transitions"] = $_SESSION['qode_eden_page_transitions'];
	}
endif;