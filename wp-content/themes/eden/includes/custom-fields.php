		...
		*/
		var $customFields =	array(
			...
			array(
				...
				"title"			=> "Page title position/type",
				"description"	=> "",
				"float_left" 	=> "yes",
				"clear_after" 	=> "",
				"type"			=> "selectbox",
				"values"		=> array(
					""		=>	"",
					"left"	=>	"Left",
					"left_image"	=>	"Left with image",
					"left_large"	=>	"Left large title",
					"center"	=>	"Center"
				),
				"scope"			=>	array("page","post","portfolio_page"),
				"capability"	=> "manage_options",
			...
			array(
				"name"			=> "show-portfolio-categories",
									...
									if($dependency != ""){
										foreach ( $dependency as $dependencyKey => $dependencyValue ) {
											foreach ( $dependencyValue as $dependencyVal ) {
												if($qode_options_eden[$dependencyKey] == $dependencyVal){
													$output = true;
													break;
												}
											}
