...
if(get_post_meta($page_id, "qode_enable_content_bottom_area", true) != ""){
	...
	if (isset($qode_options_eden['enable_content_bottom_area'])) { 
		$content_bottom_area = $qode_options_eden['enable_content_bottom_area'];
	}
}
...
if(get_post_meta($page_id, 'qode_choose_content_bottom_sidebar', true) != ""){
	...
	if(isset($qode_options_eden['content_bottom_sidebar_custom_display'])) {
		$content_bottom_area_sidebar = $qode_options_eden['content_bottom_sidebar_custom_display'];
	}
}
...
if(get_post_meta($page_id, 'qode_content_bottom_sidebar_in_grid', true) != ""){
	...
	if(isset($qode_options_eden['content_bottom_in_grid'])){if ($qode_options_eden['content_bottom_in_grid'] == "no") $content_bottom_area_in_grid = false;}
}
...
if(isset($qode_options_eden['uncovering_footer'])){if ($qode_options_eden['uncovering_footer'] == "no") $uncovering_footer = false;}
?>
	<footer <?php if($uncovering_footer){echo 'class="uncover"';} ?>>
		<div class="footer_inner clearfix">
		<?php
		$footer_in_grid = true;
		if(isset($qode_options_eden['footer_in_grid'])){
			if ($qode_options_eden['footer_in_grid'] != "yes") {
				$footer_in_grid = false;
			}
		}
		$display_footer_top = true;
		if (isset($qode_options_eden['show_footer_top'])) {
			if ($qode_options_eden['show_footer_top'] == "no") $display_footer_top = false;
		}
		
		$footer_top_columns = 4;
		if (isset($qode_options_eden['footer_top_columns'])) {
			$footer_top_columns = $qode_options_eden['footer_top_columns'];
		}
		...
		if (isset($qode_options_eden['footer_text'])) {
			if ($qode_options_eden['footer_text'] == "yes") $display_footer_text = true;
		}
