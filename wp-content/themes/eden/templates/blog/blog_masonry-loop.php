...
?>
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post_text">
				...
				<?php qode_excerpt(); ?>
				<div class="post_info">
					<span class="date"><i class="fa fa-calendar-o"></i><?php the_time('d F Y'); ?></span>
						...
						<ul class="slides">
							<?php
								...
								foreach($array_id as $img_id){ ?>
									<li><a target="_self" href="<?php the_permalink(); ?>"><?php echo wp_get_attachment_image( $img_id, 'masonry_list' ); ?></a></li>
								<?php } ?>
						</ul>
					</div>
				</div>
			...
			<?php if ( has_post_thumbnail() ) { ?>
				<div class="post_image">
					<a href="<?php the_permalink(); ?>" target="_self" title="<?php the_title_attribute(); ?>">
						<?php the_post_thumbnail('masonry_list'); ?>
					</a>
				</div>
			<?php } ?>
			<div class="post_text">
