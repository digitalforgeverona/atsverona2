...
$blog_author_info="no";
if (isset($qode_options_eden['blog_author_info'])) {
	$blog_author_info = $qode_options_eden['blog_author_info'];
}
$qode_like = "on";
			...
			<div class="post_content_holder">
				...
				<div class="post_text">
					<div class="post_text_date">
						...
						<span class="post_date_month"><?php the_time('F'); ?></span>
						...
						<div class="post_description">
							<div class="post_description_inner">
								<span class="post_author">
									<a class="post_author_link" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><i class="fa fa-user"></i><?php the_author_meta('display_name'); ?></a>
								</span>
...
?>
	<?php if( has_tag()) { ?>
		<div class="single_tags clearfix">
            <div class="tags_text"><i class="fa fa-tag"></i> <h4>Tags:</h4></div>
			<?php the_tags('', '', ''); ?>
		</div>
	<?php } ?>				
	<?php 
