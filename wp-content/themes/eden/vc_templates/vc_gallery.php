...
if ( $type == 'nivo' ) {
    ...
    $slides_wrap_end = '</ul><div class="q_gallery_title_holder"><div class="q_gallery_title_holder_inner"></div></div>';
...
foreach ( $images as $attach_id ) {
    ...
    $gal_images .= $el_start . $link_start . '<span class="q_gallery_slider" data-image_title="'.$image_title.'" data-image_caption="'.$image_caption.'" >' .$thumbnail . '</span>' . $link_end . $el_end;
}
