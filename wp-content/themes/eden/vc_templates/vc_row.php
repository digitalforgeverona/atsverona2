...
if($row_type == 'row') {
	$output .= '<div '.$anchor_id.' '.$menu_title.' '.$menu_icon.' class="' . $css_class . $css_class_type . $css_class_in_content_menu . $css_class_video . $use_row_as_box_class . $css_class_pattern . '"';
	...
	$output .= '<span class="more_facts_button_arrow"><span class="more_facts_button_arrow_inner"';
	if($background_color != ""){
		$output .= " style='border-color: ".$background_color." transparent transparent transparent;'";
	}
	$output .= '></span></span>';
	$output .= '<div class="more_facts_button_holder ' . $button_position . '">';
	$output .= '<span class="more_facts_button" data-backgroundcolor="'. $background_color . '" data-hoverbackgroundcolor="'. $background_hover_color . '" data-color="'. $color . '" data-hovercolor="'. $hover_color . '" data-morefacts="'. $more_button_label .'" data-lessfacts="'. $less_button_label . '"';
	...
	if($background_hover_color != ""){
		$output .= " style='background-color: ".$background_hover_color.";'";
	}
