...
class Woocommerce_Dropdown_Cart extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="shopping_cart_header">
			<a class="header_cart" href="<?php echo $woocommerce->cart->get_cart_url(); ?>"><i class="fa fa-2x simple_social fa-shopping-cart"></i></a>
			...
			<?php endif; ?>
                ...
                <a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" class="qbutton dark view-cart"><?php _e( 'Cart', 'woocommerce' ); ?> <i class="fa fa-shopping-cart"></i></a>
