					...
					<div id="st-footer-wrapper" style="background-color:<?php echo get_theme_mod( 'footer_widgets_bg', '#272b30' ); ?>; color:<?php echo get_theme_mod( 'footer_widgets_text', '#959798' ); ?>;">
						<aside id="sidebar-footer" class="container">
							...
							<?php if ( is_active_sidebar( 'sidebar-16' ) ) : ?>
								<div id="footer1" <?php celestial_lite_footergroup_sidebar_class(); ?> role="complementary">
									<?php dynamic_sidebar( 'sidebar-16' ); ?>
								</div><!-- #footer1 -->
							<?php endif; ?>
							
							<?php if ( is_active_sidebar( 'sidebar-17' ) ) : ?>
								<div id="footer2" <?php celestial_lite_footergroup_sidebar_class(); ?> role="complementary">
									<?php dynamic_sidebar( 'sidebar-17' ); ?>
								</div><!-- #footer2 -->
							<?php endif; ?>
							
							<?php if ( is_active_sidebar( 'sidebar-18' ) ) : ?>
								<div id="footer3" <?php celestial_lite_footergroup_sidebar_class(); ?> role="complementary">
									<?php dynamic_sidebar( 'sidebar-18' ); ?>
								</div><!-- #footer3 -->
							<?php endif; ?>
								
							<?php if ( is_active_sidebar( 'sidebar-19' ) ) : ?>
								<div id="footer4" <?php celestial_lite_footergroup_sidebar_class(); ?> role="complementary">
				...
				<div class="container">
					<div class="row">
						<div class="span12">
							...
							<div><?php echo get_theme_mod( 'copyright', 'Copyright &copy; 2013 Your Info. All rights reserved.' ); ?></div>
