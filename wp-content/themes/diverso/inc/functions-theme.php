...
function yiw_theme_setup() {     
    ...
    $image_sizes = array(
        ...
        'works-slider-widgets'  => array( 425, 170, true ),  
        'blog_small'            => array( 288, 266, true ),  
        'thumb_portfolio_3cols' => array( 280, 143, true ),  
        'thumb_gallery'         => array( 208, 168, true ),   
        'thumb_portfolio_slider'=> array( 194, 118, true ),  
    ...
    register_sidebar( yiw_sidebar_args( 'Gallery Sidebar', __( 'The sidebar used in Gallery single posts.', 'yiw'), 'widget', 'h2' ) );  
...
function yiw_breadcrumb() {
    if ( ! yiw_get_option( 'show_breadcrumb' ) || yiw_get_option( 'show_breadcrumb' ) == 'no' ) 
        return;
