...
class gallery_categories extends WP_Widget
{
    function gallery_categories() 
    {
        $widget_ops = array( 
            ...
            'description' => __('Get list of gallery categories, created on portfolio custom type.', 'yiw') 
        );

        $control_ops = array( 'id_base' => 'gallery-categories' );

        $this->WP_Widget( 'gallery-categories', 'Gallery Categories', $widget_ops, $control_ops );
    }
